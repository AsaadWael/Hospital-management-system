...
<html lang="en">
	<head>
		<title>Doctor | Manage Hastalar</title>
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Doctor | Manage Hastalar</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Doctor</span>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15">Manage <span class="text-bold">Hastalar</span></h5>
<?php
                               $vid=$_GET['viewid'];
...
<p align="center">                            
 <button class="btn btn-primary waves-effect waves-light w-lg" data-toggle="modal" data-target="#myModal">Add Tıbbi Geçmiş</button></p>  
  ...
  <div class="modal-dialog" role="document">
     <div class="modal-content">
      <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Add Tıbbi Geçmiş</h5>
