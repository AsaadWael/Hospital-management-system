                ...
                <div class="row">
                    ...
                    <div id="menu" class="col-lg-8 col-md-9 d-none d-md-block nav-item">
                        <ul>
                            ...
                            <li><a href="#contact_us">Bize Ulaşın</a></li>
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Hastane Yönetim Sistemi</h5>
                        ...
                        <div class="blog-single">
                            ...
                            <div class="blog-single-det">
                                ...
                                <a href="hms/user-login.php" target="_blank">
                                    <button class="btn btn-success btn-sm">Buraya Tıklayın</button>
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <section id="services" class="key-features department">
        <div class="container">
            <div class="inner-title">
                ...
                <p>Bazı temel özelliklerimize göz atın</p>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-key">
                        ...
                        <h5>Yüksek Kaliteli Tedaviler</h5>
        ...
        <div class="row no-margin">
            ...
            <div  class="col-sm-12 cop-ck">
                ...
                <h2 >İletişim Formu</h2>
                    <div class="row cf-ro">
                        <div  class="col-sm-3"><label>İsim Girin :</label></div>
                        <div class="col-sm-8"><input type="text" placeholder="İsim Girin" name="fullname" class="form-control input-sm" required ></div>
                    </div>
                    <div  class="row cf-ro">
                        <div  class="col-sm-3"><label>E-posta Adresi :</label></div>
                        <div class="col-sm-8"><input type="text" name="emailid" placeholder="E-posta Adresi Girin" class="form-control input-sm"  required></div>
                    </div>
                     <div  class="row cf-ro">
                        <div  class="col-sm-3"><label>Mobil Numara:</label></div>
                        <div class="col-sm-8"><input type="text" name="mobileno" placeholder="Mobil Numara Girin" class="form-control input-sm" required ></div>
                    </div>
                     <div  class="row cf-ro">
                        <div  class="col-sm-3"><label>Mesaj Girin:</label></div>
                        <div class="col-sm-8">
                          <textarea rows="5" placeholder="Mesajınızı Girin" class="form-control input-sm" name="description" required></textarea>
                        </div>
                    </div>
                     <div  class="row cf-ro">
                        <div  class="col-sm-3"><label></label></div>
                        <div class="col-sm-8">
                         <button class="btn btn-success btn-sm" type="submit" name="submit">Mesaj Gönder</button>
                        </div>
                </div>
            </form>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <ul class="list-unstyled link-list">
                        <li><a ui-sref="about" href="#about_us">Hakkımızda</a><i class="fa fa-angle-right"></i></li>
                        ...
                        <li><a ui-sref="contact" href="#contact_us">Bize ulaşın</a><i class="fa fa-angle-right"></i></li>
                    </ul>
                </div>
...
?>
                        ...
                        E-posta: <a href="mailto:<?php  echo $row['Email'];?>" class=""><?php  echo $row['Email'];?></a><br>
                        Çalışma Saatleri: <?php  echo $row['OpenningTime'];?>
                    </address>
